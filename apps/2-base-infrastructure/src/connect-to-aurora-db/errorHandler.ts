...
export class ErrorHandler extends Error{
    constructor (public statusCode: number, public msg: string, public errorCode: string, public errorMsgs?: {[key: string]: string}){
        super( msg )
    }
}
...
export class ErrorHandlerObject extends Error{
    constructor (public statusCode: number, public msg: string, public errorCode: string, public errorMsgs: object ){
        super( msg )
    }
}
